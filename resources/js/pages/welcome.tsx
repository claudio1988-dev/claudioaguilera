        ...
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-[95vw] 2xl:max-w-[1600px] lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium text-2xl lg:text-4xl">
                                Hi, I'm Claudio Aguilera
                            </h1>
                            ...
                            <div id="about" className="mb-8">
                                ...
                                <p className="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                                    Passionate developer with expertise in modern web technologies including React, Laravel, Node.js, and cloud platforms.
                                    I specialize in creating scalable, user-friendly applications that solve real-world problems.
                                </p>
                                <p className="text-[#706f6c] dark:text-[#A1A09A]">
                                    With over 5 years of experience, I've worked on diverse projects from e-commerce platforms to complex web applications,
                                    always focusing on clean code, performance, and exceptional user experiences.
                                </p>
                            </div>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    {[
                                        ...
                                        <div key={skill.name} className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 text-[#1b1b18] rounded-lg text-sm font-medium dark:from-gray-700 dark:to-gray-600 dark:text-[#EDEDEC] hover:shadow-md transition-shadow">
                            ...
                            <div id="contact">
                                ...
                                <ul className="flex gap-3 text-sm leading-normal">
                                    ...
                                    <li>
                                        <a
                                            href="https://github.com/claudioaguilera"
                                            target="_blank"
                                            className="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                                        >
                                            GitHub
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[500px] lg:rounded-t-none lg:rounded-r-lg dark:from-gray-800 dark:via-gray-700 dark:to-gray-900">
                            <svg
                                className="w-full max-w-none translate-y-0 text-blue-600 opacity-100 transition-all duration-750 dark:text-blue-400 starting:translate-y-6 starting:opacity-0"
                                viewBox="0 0 438 104"
                                fill="none"
                            ...
                            <div className="relative -mt-[4.9rem] -ml-8 w-[500px] max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:hidden flex items-center justify-center h-full">
                                <div className="text-center">
                                    <div className="w-40 h-40 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mx-auto mb-6 shadow-lg">
                                        CA
                                    </div>
                                    <p className="text-gray-700 text-xl font-semibold">Claudio Aguilera</p>
                                    <p className="text-gray-600 text-lg">Full-Stack Developer</p>
                                    <div className="mt-4 flex justify-center space-x-4">
                                        <a href="https://github.com/claudioaguilera" className="text-gray-500 hover:text-blue-600 transition-colors">
                                        ...
                                        <a href="https://linkedin.com/in/claudioaguilera" className="text-gray-500 hover:text-blue-600 transition-colors">
                                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div className="relative -mt-[4.9rem] -ml-8 w-[500px] max-w-none lg:-mt-[6.6rem] lg:ml-0 hidden dark:block flex items-center justify-center h-full">
                                <div className="text-center">
                                    <div className="w-40 h-40 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full flex items-center justify-center text-white text-4xl font-bold mx-auto mb-6 shadow-lg">
                                        CA
                                    </div>
                                    <p className="text-gray-200 text-xl font-semibold">Claudio Aguilera</p>
                                    <p className="text-gray-300 text-lg">Full-Stack Developer</p>
                                    <div className="mt-4 flex justify-center space-x-4">
                                        <a href="https://github.com/claudioaguilera" className="text-gray-400 hover:text-blue-400 transition-colors">
                                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                                        </a>
                                        <a href="https://linkedin.com/in/claudioaguilera" className="text-gray-400 hover:text-blue-400 transition-colors">
                                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <svg
                                className="relative -mt-[4.9rem] -ml-8 w-[448px] max-w-none lg:-mt-[6.6rem] lg:ml-0 hidden"
                                viewBox="0 0 440 376"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
